...
public enum EnumPotionEffect {
    ...
    public static String getLocalizedName(ItemStack itemStack, String locale) {
        switch (itemStack.getType()) {
            case SPLASH_POTION: return LegacyTranslator.translateToLocal(getUnlocalizedSplashName(itemStack), locale);
            case LINGERING_POTION: return LegacyTranslator.translateToLocal(getUnlocalizedLingeringName(itemStack), locale);
            case TIPPED_ARROW: return LegacyTranslator.translateToLocal(getUnlocalizedArrowName(itemStack), locale);
            default: return LegacyTranslator.translateToLocal(getUnlocalizedName(itemStack), locale);
        }
    }
